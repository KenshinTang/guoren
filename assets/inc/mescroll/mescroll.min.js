...
(function(name, definition) {
        ...
        MeScroll.extend(optDown, {
            ...
            inOffset: function(mescroll) {
                ...
                if (mescroll.downProgressDom) {
                    var rt = 1 + Math.floor(Math.random() * 5);
                    mescroll.downProgressDom.innerHTML = "<img src='css/stIconfile/" + rt + ".gif'/>"
                }
            },
    ...
    MeScroll.prototype.extendUpScroll = function(optUp) {
        ...
        MeScroll.extend(optUp, {
            ...
            htmlNodata: '<p class="empty-tip">没有更多数据啦~~</p>', // 无数据的布局
    ...
    MeScroll.prototype.initDownScroll = function() {
        ...
        me.touchendEvent = function() {
            ...
            me.optDown.onEnd && me.optDown.onEnd(me); // 下拉过程中的touchend
            if (me.os.pc) {
    ...
    /* 触发下拉刷新 */
    MeScroll.prototype.triggerDownScroll = function(isshowDownScroll) {
    ...
    MeScroll.prototype.endDownScroll = function() {
        ...
        var me = this;
        me.downProgressDom.innerHTML = "<img src='css/stIconfile/end.gif'/>";
        // 结束下拉刷新的方法
    ...
    MeScroll.prototype.initUpScroll = function() {
        ...
        me.scrollEvent = function() {
            ...
            if (!bgdiv) {
                ...
                bgdiv = true;
                timerscroll = setTimeout(isScrollEnd, 500);
                ...
                function isScrollEnd() {
                    ...
                    if (t2 == t1) {
                        //开启
                        //me.scrollDom.setAttribute('class', me.scrollDom.getAttribute('class').replace(me.optUp.scrollbar.barClass, ''))
                        Comm.upSlide(2);
                        bgdiv = false;
     ...
     * 1.默认null, 则显示下拉刷新的进度布局
     * 2.传参true, 不传参,则显示上拉加载的进度布局
    ...
    MeScroll.prototype.resetUpScroll = function(isShowLoading) {
        if (this.optUp && this.optUp.use) {
            ...
            if (this.downProgressDom) {
                var rt = 1 + Math.floor(Math.random() * 5);
                this.downProgressDom.innerHTML = "<img src='css/stIconfile/" + rt + ".gif'/>"
            }
            setTimeout(function() {
                _this.optUp.callback && _this.optUp.callback(page, _this); // 执行上拉回调
            }, 800)
        }
    }
