  ...
  Photos.prototype = {
    ...
    open: function (index) {
      ...
      if (!this.modal) {
        ...
        this.wrapper.transform('translate3d(-' + $(window).width()*(index?index:0) + 'px,0,0)');
